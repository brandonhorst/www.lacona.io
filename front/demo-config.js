const output = {
  ...
  volumes: [
    {name: 'Lacona.dmg', ejectable: true},
    {name: 'Alfred.dmg', ejectable: true},
    {name: 'CD Drive', ejectable: true}
  ],
  usHolidays: [
  ...
  apps: [
    {name: 'Calendar', type: 'app'},
    {name: 'Contacts', type: 'app'},
    {name: 'FaceTime', type: 'app'},
    {name: 'Finder', type: 'app'},
    {name: 'Game Center', type: 'app'},
    {name: 'GarageBand', type: 'app'},
    {name: 'iBooks', type: 'app'},
    {name: 'iMovie', type: 'app'},
    {name: 'iPhoto', type: 'app'},
    {name: 'iTunes', type: 'app'},
    {name: 'Keynote', type: 'app'},
    {name: 'App Store', type: 'app'},
    {name: 'Mail', type: 'app'},
    {name: 'Maps', type: 'app'},
    {name: 'Messages', type: 'app'},
    {name: 'Notes', type: 'app'},
    {name: 'Numbers', type: 'app'},
    {name: 'Pages', type: 'app'},
    {name: 'Photo Booth', type: 'app'},
    {name: 'Reminders', type: 'app'},
    {name: 'Safari', type: 'app'},
    {name: 'Google Chrome', type: 'app'},
    {name: 'Firefox', type: 'app'},
    {name: 'Automator', type: 'app'},
    {name: 'Calculator', type: 'app'},
    {name: 'Chess', type: 'app'},
    {name: 'Dictionary', type: 'app'},
    {name: 'DVD Player', type: 'app'},
    {name: 'Font Book', type: 'app'},
    {name: 'Image Capture', type: 'app'},
    {name: 'Preview', type: 'app'},
    {name: 'QuickTime Player', type: 'app'},
    {name: 'Stickies', type: 'app'},
    {name: 'System Information', type: 'app'},
    {name: 'TextEdit', type: 'app'},
    {name: 'VoiceOver Utility', type: 'app'}
  ],
  bookmarks: [
    {kMDItemDisplayName: 'Facebook', kMDItemURL:'http://facebook.com'},
    {kMDItemDisplayName: 'Twitter', kMDItemURL:'http://twitter.com'},
    {kMDItemDisplayName: 'Google', kMDItemURL:'http://google.com'},
    {kMDItemDisplayName: 'Lifehacker', kMDItemURL:'http://lifehacker.com'},
    {kMDItemDisplayName: 'xkcd', kMDItemURL:'http://xkcd.com'},
    {kMDItemDisplayName: 'Github', kMDItemURL:'http://github.com'},
    {kMDItemDisplayName: 'Gmail', kMDItemURL:'http://gmail.com'},
    {kMDItemDisplayName: 'Youtube', kMDItemURL:'http://youtube.com'},
    {kMDItemDisplayName: 'Wikipedia', kMDItemURL:'http://wikipedia.org'},
    {kMDItemDisplayName: 'Ebay', kMDItemURL:'http://ebay.com'}
  ],
  preferencePanes: [
    {kMDItemDisplayName: 'Displays', kMDItemPath: 'Displays'},
    {kMDItemDisplayName: 'Desktop & Screen Saver', kMDItemPath: 'Desktop & Screen Saver'},
    {kMDItemDisplayName: 'Extensions', kMDItemPath: 'Extensions'},
    {kMDItemDisplayName: 'Energy Saver', kMDItemPath: 'Energy Saver'},
    {kMDItemDisplayName: 'Sound', kMDItemPath: 'Sound'},
    {kMDItemDisplayName: 'Keyboard', kMDItemPath: 'Keyboard'},
    {kMDItemDisplayName: 'Internet Accounts', kMDItemPath: 'Internet Accounts'},
    {kMDItemDisplayName: 'Date & Time', kMDItemPath: 'Date & Time'},
    {kMDItemDisplayName: 'Accessibility', kMDItemPath: 'Accessibility'},
    {kMDItemDisplayName: 'Security & Privacy', kMDItemPath: 'Security & Privacy'},
    {kMDItemDisplayName: 'Dock', kMDItemPath: 'Dock'},
    {kMDItemDisplayName: 'Profiles', kMDItemPath: 'Profiles'},
    {kMDItemDisplayName: 'Network', kMDItemPath: 'Network'},
    {kMDItemDisplayName: 'Notifications', kMDItemPath: 'Notifications'},
    {kMDItemDisplayName: 'Fibre Channel', kMDItemPath: 'Fibre Channel'},
    {kMDItemDisplayName: 'App Store', kMDItemPath: 'App Store'},
    {kMDItemDisplayName: 'Time Machine', kMDItemPath: 'Time Machine'},
    {kMDItemDisplayName: 'General', kMDItemPath: 'General'},
    {kMDItemDisplayName: 'Dictation & Speech', kMDItemPath: 'Dictation & Speech'},
    {kMDItemDisplayName: 'Spotlight', kMDItemPath: 'Spotlight'},
    {kMDItemDisplayName: 'Ink', kMDItemPath: 'Ink'},
    {kMDItemDisplayName: 'Language & Region', kMDItemPath: 'Language & Region'},
    {kMDItemDisplayName: 'CDs & DVDs', kMDItemPath: 'CDs & DVDs'},
    {kMDItemDisplayName: 'Sharing', kMDItemPath: 'Sharing'},
    {kMDItemDisplayName: 'Users & Groups', kMDItemPath: 'Users & Groups'},
    {kMDItemDisplayName: 'Bluetooth', kMDItemPath: 'Bluetooth'},
    {kMDItemDisplayName: 'Mouse', kMDItemPath: 'Mouse'},
    {kMDItemDisplayName: 'Trackpad', kMDItemPath: 'Trackpad'},
    {kMDItemDisplayName: 'Mission Control', kMDItemPath: 'Mission Control'},
    {kMDItemDisplayName: 'Startup Disk', kMDItemPath: 'Startup Disk'},
    {kMDItemDisplayName: 'Parental Controls', kMDItemPath: 'Parental Controls'},
    {kMDItemDisplayName: 'Printers & Scanners', kMDItemPath: 'Printers & Scanners'},
    {kMDItemDisplayName: 'iCloud', kMDItemPath: 'iCloud'}
  ],
  spotlightFiles: [
    {kMDItemPath: '/Users/LaconaUser/Documents/log.csv'},
    {kMDItemPath: '/Users/LaconaUser/Documents/lacona-logo.png'},
    {kMDItemPath: '/Users/LaconaUser/Documents/kickstarter-video.m4v'},
    {kMDItemPath: '/Users/LaconaUser/Documents/document.docx'},
    {kMDItemPath: '/Users/LaconaUser/Documents/my-document.docx'},
    {kMDItemPath: '/Users/LaconaUser/Projects/test/main.js'},
    {kMDItemPath: '/Users/LaconaUser/Projects/test/package.json'},
    {kMDItemPath: '/Users/LaconaUser/Projects/test/lodash.js'},
    {kMDItemPath: '/Users/LaconaUser/Projects/test/react-router.jsx'},
    {kMDItemPath: '/Users/LaconaUser/Documents/Presentations/briefing 1_2.keynote'},
    {kMDItemPath: '/Users/LaconaUser/Documents/Presentations/briefing 2_24.keynote'},
    {kMDItemPath: '/Users/LaconaUser/Documents/Presentations/briefing 5_5.keynote'},
    {kMDItemPath: '/Users/LaconaUser/status-updates.txt'},
    {kMDItemPath: '/Users/LaconaUser/todo.txt'},
    {kMDItemPath: '/Users/LaconaUser/Projects/cpp-test/main.cpp'},
    {kMDItemPath: '/Users/LaconaUser/Projects/cpp-test/main.h'},
    {kMDItemPath: '/Users/LaconaUser/Projects/cpp-test/quick-brown-fox.js'},
    {kMDItemPath: '/Users/LaconaUser/Projects/cpp-test/overjumper.cs'},
    {kMDItemPath: '/Users/LaconaUser/Projects/cpp-test/overjumper.h'},
    {kMDItemPath: '/Users/LaconaUser/Projects/cpp-test/lazy_dog.js'}
  ],
  rootFiles:
  { '/':
